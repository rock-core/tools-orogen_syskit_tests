...
#ifndef OROGEN_SYSKIT_TESTS_BLOCKINGHOOKS_TASK_HPP
#define OROGEN_SYSKIT_TESTS_BLOCKINGHOOKS_TASK_HPP

#include "orogen_syskit_tests/BlockingHooksBase.hpp"
...
namespace orogen_syskit_tests {
     ...
     */
    class BlockingHooks : public BlockingHooksBase
    {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class BlockingHooksBase;

    protected:
        void doRequiredSleep(std::string const& currentHookName);

    public:
        /** TaskContext constructor for BlockingHooks
         ...
         *                      configure state.
         */
        BlockingHooks(std::string const& name = "orogen_syskit_tests::BlockingHooks");
