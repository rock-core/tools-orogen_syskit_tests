...
#ifndef OROGEN_SYSKIT_LOGICAL_TIME_LOGGING_TEST_TYPE_TASK_HPP
#define OROGEN_SYSKIT_LOGICAL_TIME_LOGGING_TEST_TYPE_TASK_HPP

#include "orogen_syskit_tests/LogicalTimeLoggingTestBase.hpp"
#include <base/Time.hpp>

namespace orogen_syskit_tests {
    /*! \class LogicalTimeLoggingTest
     * \brief An LogicalTimeLoggingTest component
     */
    class LogicalTimeLoggingTest : public LogicalTimeLoggingTestBase {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class LogicalTimeLoggingTestBase;

    protected:
        base::Time m_test_type_timestamp;

    public:
        /** TaskContext constructor for LogicalTimeLoggingTest
         ...
         *                      configure state.
         */
        LogicalTimeLoggingTest(
            std::string const& name = "orogen_syskit_tests::LogicalTimeLoggingTest");
