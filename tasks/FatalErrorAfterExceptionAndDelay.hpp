...
#ifndef OROGEN_SYSKIT_TESTS_FATALERRORAFTEREXCEPTIONANDDELAY_TASK_HPP
#define OROGEN_SYSKIT_TESTS_FATALERRORAFTEREXCEPTIONANDDELAY_TASK_HPP

#include "orogen_syskit_tests/FatalErrorAfterExceptionAndDelayBase.hpp"

namespace orogen_syskit_tests {
    /*! \class FatalErrorAfterExceptionAndDelay
     * \brief A component that triggers a fatal error in stopHook after a transition to
     *exception from updateHook, followed by a delay.
     */
    class FatalErrorAfterExceptionAndDelay : public FatalErrorAfterExceptionAndDelayBase
    {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class FatalErrorAfterExceptionAndDelayBase;

    protected:

    public:
        /** TaskContext constructor for FatalErrorAfterExceptionAndDelay
         ...
         *                      configure state.
         */
        FatalErrorAfterExceptionAndDelay(std::string const& name = "orogen_syskit_tests::FatalErrorAfterExceptionAndDelay");

        ~FatalErrorAfterExceptionAndDelay();
