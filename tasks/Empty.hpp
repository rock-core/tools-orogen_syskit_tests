...
#ifndef OROGEN_SYSKIT_TESTS_EMPTY_TASK_HPP
#define OROGEN_SYSKIT_TESTS_EMPTY_TASK_HPP

#include "orogen_syskit_tests/EmptyBase.hpp"

namespace orogen_syskit_tests {
    /*! \class Empty
     * \brief An empty component
     */
    class Empty : public EmptyBase
    {
    ...
    public:
        /** TaskContext constructor for Empty
         ...
         *                      configure state.
         */
        Empty(std::string const& name = "orogen_syskit_tests::Empty");
