...
#ifndef OROGEN_SYSKIT_TESTS_STATIC_TEST_TYPE_TASK_HPP
#define OROGEN_SYSKIT_TESTS_STATIC_TEST_TYPE_TASK_HPP

#include "orogen_syskit_tests/StaticTestTypeBase.hpp"

namespace orogen_syskit_tests {
    /*! \class StaticTestType
     * \brief An StaticTestType component
     */
    class StaticTestType : public StaticTestTypeBase {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class StaticTestTypeBase;

    protected:
        int m_test_type_value = 0;
    public:
        /** TaskContext constructor for StaticTestType
         ...
         *                      configure state.
         */
        StaticTestType(std::string const& name = "orogen_syskit_tests::StaticTestType");
