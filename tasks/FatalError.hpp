...
#ifndef OROGEN_SYSKIT_TESTS_FATALERROR_TASK_HPP
#define OROGEN_SYSKIT_TESTS_FATALERROR_TASK_HPP

#include "orogen_syskit_tests/FatalErrorBase.hpp"

namespace orogen_syskit_tests {
    /*! \class FatalError
     * \brief A component that triggers a fatal error in stopHook
     *
     * This component is used to test the handling of fatal errors
     */
    class FatalError : public FatalErrorBase
    {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class FatalErrorBase;

    protected:

    public:
        /** TaskContext constructor for FatalError
         ...
         *                      configure state.
         */
        FatalError(std::string const& name = "orogen_syskit_tests::FatalError");
